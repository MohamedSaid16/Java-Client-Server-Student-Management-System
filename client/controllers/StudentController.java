...
public class StudentController {
    ...
    public StudentController() {
       this.clientService = new ClientService(); // Use constructor instead of singleton
    }
    ...
    public List<Map<String, String>> getStudentGrades(int studentId) {
        // Return empty list for now - you'll need to implement this in ClientService
        return List.of();
    }
    ...
    public List<Map<String, String>> getGradesBySubject(int studentId, String subject) {
        try {
            ...
            if (allGrades != null) {
                // Simple filtering without streams (compatibility)
                java.util.ArrayList<Map<String, String>> filtered = new java.util.ArrayList<>();
    ...
    public double getOverallAverage(int studentId) {
        // Simulate for now - you'll need to implement this in ClientService
        return 14.5;
    }
    ...
    private String getAcademicLevel(double average) {
        ...
        else if (average >= 14) return "جيد جداً";
    ...
    public List<Map<String, String>> getSampleGrades() {
        java.util.ArrayList<Map<String, String>> sampleGrades = new java.util.ArrayList<>();
