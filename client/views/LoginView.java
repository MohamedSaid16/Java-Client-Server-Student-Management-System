...
public class LoginView extends JFrame {
    ...
    private void initializeUI() {
        ...
        userTypeCombo = new JComboBox<>(new String[]{"STUDENT", "TEACHER", "RESPONSABLE", "ADMIN"});
    ...
    public String getUserType() {
        return (String) userTypeCombo.getSelectedItem();
    }
    ...
    public void navigateToDashboard(Map<String, String> userInfo) {
        ...
        switch (userType) {
            case "STUDENT":
                ...
                new StudentView(clientService, userInfo).setVisible(true);
                break;
            case "TEACHER":
            ...
            case "RESPONSABLE":
                ...
                new ResponsableView(clientService, userInfo).setVisible(true);
                break;
            case "ADMIN":
                new AdminView(clientService, userInfo).setVisible(true);
                break;
            default:
